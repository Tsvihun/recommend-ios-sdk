//
//  RECKeychainService.swift
//  Recommend_test
//
//  Created by evgeniy.pinchuk on 04.11.2024.
//
...
public class RECKeychainService: NSObject {
    
    class func updateItem(service: String, account:String, data: String) {
    ...
    class func removeItem(service: String, account:String) {
    ...
    class func saveItem(service: String, account:String, data: String) {
    ...
    class func getItem(service: String, account:String) -> String? {
        // Instantiate a new default keychain query
